...
/**
 * Calculates number of pizzas needed to fit screen
 * @param  {int} screenHeight currentScreen Height
 * @return {int} number of pizzas needed
 */
function calculateNumberOfPizzas( screenHeight ) {
